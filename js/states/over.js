...
export default class Over extends Phaser.State {
    ...
    create() {
        ...
        this.gameOverTitle = new Phaser.Text(this.game, this.game.world.centerX, this.game.world.centerY-200, 'GAME' +
            ' OVER', {
            font: '36px Tahoma',
            fill: '#00ff82',
            stroke: '#00ff82',
        ...
        this.gameOverTitle.setShadow(2, 2, "#fe0063", 2, true, true);
